...
exports.getTableData = (req, res) => {
  ...
  const query = (includeWeather) => {
    return models.sequelize.query(
      ...
      GROUP BY game.weather_id ${includeWeather ? ', weather.id' : ''} AND venue.id, venue.lat, venue.lng, venue.name, venue.team, total_rush_yds, total_rush_attempts, total_yds_per_carry, passing_yds_total, passing_attempts_total, passing_completions_total, passing_comp_pct_total, passing_int_total
      ;`,
      {
        replacements: {
          venue,
